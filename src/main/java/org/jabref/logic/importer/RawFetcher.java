...
/**
 * This interface allows SearchBasedParserFetcher fetchers to test their corresponding library APIs for their advanced search options, e.g. search in the "title" field.
 */
